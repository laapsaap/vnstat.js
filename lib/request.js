...
function vnstat(netdev, netdevs, res, opt) {
	...
	exec(command, function (error, stdout, stderr) {
		...
		body = 	"<div id=\"graph\"><img alt=\"/"+netdev+"/graph"+opt+"\" class=\"shadow\" src=\"/"+netdev+"/graph"+opt+"\" /></div>"+
...
*/
	...
	var body = "<div id=\"graph\"><img alt=\"/"+netdev+"/graph-s\" class=\"shadow\" src=\"/"+netdev+"/graph-s\" /></div>"+
